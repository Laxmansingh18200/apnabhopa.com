              ...
              <div className="bg-white-A700 border border-bluegray-900 border-solid flex md:flex-1 flex-col items-center justify-start p-[49px] md:px-10 sm:px-5 w-[41%] md:w-full">
                <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-start mb-[3px] rounded-[10px] w-[93%] md:w-full">
                  ...
                  <div className="flex flex-col gap-[30px] items-start justify-start pt-[3px] rounded-[10px] w-full">
                    ...
                    <Button
                      className="common-pointer bg-bluegray-900 cursor-pointer font-medium font-poppins min-w-[400px] sm:min-w-full py-5 rounded-[10px] text-base text-center text-white-A700 tracking-[0.08px]"
