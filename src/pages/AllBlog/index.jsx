            ...
            <div className="flex flex-col md:gap-10 gap-[70px] items-center justify-start md:px-5 w-[45%] md:w-full">
              ...
              <div className="bg-gray-50 flex md:flex-col flex-row gap-1.5 items-center justify-end pl-2.5 rounded-[15px] w-full">
                <Input
                  ...
                  className="leading-[normal] p-0 placeholder:text-black-900 sm:pr-5 text-black-900 text-left text-lg tracking-[-0.50px] w-full"
                  wrapClassName="bg-gray-50 md:flex-1 md:mt-0 my-[13px] pb-[19px] pl-3.5 pr-[35px] pt-[13px] w-[82%] md:w-full"
                ></Input>
              ...
              <div className="flex md:flex-1 flex-col gap-[50px] items-center justify-start w-3/4 md:w-full">
                  ...
                  <div className="gap-5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
                    <div className="flex flex-1 flex-col items-center justify-start w-full">
                      <div className="flex flex-col gap-4 items-start justify-start w-full">
                        ...
                        <Button
                          className="common-pointer bg-black-900 cursor-pointer flex items-center justify-center min-w-[138px] pl-[30px] py-2.5 rounded-lg"
                ...
                <div className="flex flex-row gap-2.5 items-center justify-center pb-[3px] pr-[3px] w-1/4 md:w-full">
                  <Img
                    ...
                    alt="arrowleft"
                  />
                  <Button className="bg-bluegray-900 cursor-pointer font-semibold h-[35px] leading-[normal] py-[9px] rounded-[5px] text-center text-sm text-white-A700 tracking-[-0.50px] w-[35px]">
                    1
                  </Button>
                  <Button className="bg-gray-100 cursor-pointer font-semibold h-[35px] leading-[normal] py-[9px] rounded-[5px] text-black-900 text-center text-sm tracking-[-0.50px] w-[35px]">
                    2
                  </Button>
                  <Button className="bg-gray-100 cursor-pointer font-semibold h-[35px] leading-[normal] py-[9px] rounded-[5px] text-black-900 text-center text-sm tracking-[-0.50px] w-[35px]">
                    3
                  </Button>
                  <Button className="bg-gray-100 flex h-[35px] items-center justify-center p-[7px] rounded-[5px] w-[35px]">
