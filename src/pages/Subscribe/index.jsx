        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col font-poppins gap-[50px] items-center justify-start max-w-[1140px] mt-[50px] mx-auto md:px-5 w-full">
            <div className="bg-white-A700 flex flex-row gap-[30px] items-center justify-center sm:pr-5 pr-[39px] rounded-[22px] w-1/5 md:w-full">
              <Button className="bg-bluegray-900 cursor-pointer leading-[normal] min-w-[111px] py-[17px] rounded-lg text-[10px] text-center text-white-A700 tracking-[0.83px]">
                MONTHLY
              </Button>
              <Text
            ...
            >
              <div className="border border-bluegray-900 border-solid flex flex-1 flex-col items-start justify-end p-9 sm:px-5 w-full">
                ...
                <Button className="border border-bluegray-900 border-solid cursor-pointer font-inter leading-[normal] min-w-[260px] ml-1 md:ml-[0] mt-6 py-[15px] text-bluegray-900 text-center text-lg tracking-[-0.50px]">
                  Subscribe
                </Button>
              </div>
              <div className="border border-bluegray-900 border-solid flex flex-1 flex-col gap-[50px] items-center justify-end p-9 sm:px-5 w-full">
                ...
                <div className="flex flex-col items-start justify-start w-[98%] md:w-full">
                  ...
                  <Button className="bg-bluegray-900 cursor-pointer font-inter leading-[normal] min-w-[260px] mt-6 py-[15px] text-center text-lg text-white-A700 tracking-[-0.50px]">
                    Subscribe
                  </Button>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-[49px] items-center justify-start w-full">
              <div className="flex flex-col gap-7 items-center justify-start rounded-lg w-full">
                <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between rounded-lg w-full">
                  ...
                  <Button
                    className="common-pointer bg-bluegray-900 cursor-pointer font-semibold leading-[normal] min-w-[122px] sm:mt-0 mt-[5px] py-3 rounded-lg text-center text-sm text-white-A700 tracking-[-0.50px]"
              ...
              >
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-[22px] items-start justify-start w-full">
                    ...
                    >
                      <div className="bg-gradient  flex flex-col md:gap-10 gap-[162px] justify-end p-[17px] w-full">
                        <Input
                          ...
                          className="font-bold leading-[normal] p-0 placeholder:text-white-A700 text-left text-white-A700 text-xs tracking-[0.12px] w-full"
                          wrapClassName="bg-deep_purple-A700 md:ml-[0] ml-[267px] mr-1.5 mt-1.5 px-[15px] py-[5px] w-[29%]"
                        ></Input>
                        <Text
                    ...
                    <Button
                      className="common-pointer bg-black-900 cursor-pointer flex items-center justify-center min-w-[151px] ml-3 md:ml-[0] pl-[30px] py-2.5 rounded-lg"
                    ...
                    >
                      <div className="leading-[normal] sm:pl-5 text-left text-sm text-white-A700 tracking-[-0.50px]">
                        Read More
                      </div>
                    </Button>
                  </div>
                  ...
                  <div className="flex flex-col gap-[21px] items-start justify-start w-full">
                    ...
                    >
                      <div className="bg-gradient  flex flex-col md:gap-10 gap-[167px] justify-end p-4 w-full">
                        <Button className="bg-orange-A700 cursor-pointer font-bold leading-[normal] min-w-[78px] md:ml-[0] ml-[300px] mr-2 mt-2 py-[5px] text-center text-white-A700 text-xs tracking-[0.12px]">
                          Finance
                        </Button>
                        <Text
                    ...
                    <Button
                      className="common-pointer bg-black-900 cursor-pointer flex items-center justify-center min-w-[151px] pl-[30px] py-2.5 rounded-lg"
                      onClick={() => navigate("/sigleblog")}
                      rightIcon={
                        <Img
                          className="h-[18px] ml-[5px] mr-[30px] my-2.5"
                ...
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-[22px] items-start justify-start w-full">
                    ...
                    >
                      <div className="bg-gradient  flex flex-col md:gap-10 gap-[162px] justify-end p-[17px] w-full">
                        <Button className="bg-red-900 cursor-pointer font-bold leading-[normal] min-w-[78px] md:ml-[0] ml-[298px] mr-1.5 mt-1.5 py-[5px] text-center text-white-A700 text-xs tracking-[0.12px]">
                          Political
                        </Button>
                        <Text
                          className="mr-[267px] text-white-A700 text-xs tracking-[-0.50px]"
