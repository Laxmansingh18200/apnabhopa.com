            ...
            <div className="flex md:flex-col flex-row md:gap-10 gap-24 items-center justify-start md:px-5 w-[95%] md:w-full">
              <div className="flex flex-col md:gap-10 gap-[78px] justify-start w-[55%] md:w-full">
                ...
                <div className="h-[394px] md:h-[641px] relative w-full">
                  <div className="absolute flex md:flex-col flex-row gap-5 h-full inset-[0] items-start justify-center m-auto pb-[23px] sm:pl-5 pl-[23px] w-[97%]">
                    <div className="flex flex-col items-center justify-start md:ml-[0] ml-[304px] w-[33%] md:w-full">
                      <div className="flex flex-col gap-4 items-start justify-start w-full">
                        ...
                        >
                          <div className="bg-gradient  flex flex-col md:gap-10 gap-[108px] justify-start p-[13px] w-full">
                            <Input
                              ...
                              className="font-bold leading-[normal] md:h-auto p-0 placeholder:text-white-A700 sm:h-auto sm:px-5 text-[10px] text-left text-white-A700 tracking-[-0.50px] w-full"
                              wrapClassName="bg-deep_purple-A700 md:ml-[0] ml-[177px] mr-0.5 mt-0.5 px-[21px] py-1.5 w-[36%]"
                            ></Input>
                            <Text
                        ...
                        <Button
                          className="bg-black-900 cursor-pointer flex items-center justify-center min-w-[138px] pl-[30px] py-2.5 rounded-lg"
                          rightIcon={
                            <Img
                        ...
                        >
                          <div className="leading-[normal] sm:pl-5 text-left text-white-A700 text-xs tracking-[-0.50px]">
                            Read More
                          </div>
                        </Button>
                      </div>
                  ...
                  <Button className="absolute bg-white-A700 border-2 border-solid border-white-A700 flex h-[60px] inset-y-[0] items-center justify-center my-auto p-[15px] right-[0] rotate-[180deg] rounded-[50%] w-[60px]">
                    <Img
                      className="h-[27px]"
                  ...
                  <div className="flex flex-col gap-[30px] items-center justify-start w-full">
                    <div className="flex flex-col font-poppins items-center justify-start pt-[3px] w-full">
                      ...
                      <div className="flex flex-row items-end justify-between mt-5 w-full">
                        <CheckBox
                          className="font-medium text-base text-black-900 text-left tracking-[0.08px]"
                          inputClassName="border-[1.5px] border-black-900 border-solid h-6 mr-[5px] rounded w-6"
                          name="H4"
                          id="H4"
                          label="Remember me?"
                        ></CheckBox>
                    ...
                    <Button
                      className="common-pointer bg-bluegray-900 cursor-pointer font-medium font-poppins min-w-[400px] sm:min-w-full py-[18px] rounded-[10px] text-base text-center text-white-A700 tracking-[0.08px]"
                      onClick={() => navigate("/")}
                    >
                      Login
                    </Button>
