          ...
          <div className="bg-white-A700 border border-bluegray-900 border-solid flex flex-col items-center justify-start mt-[50px] p-[52px] md:px-5 w-[37%] md:w-full">
            <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-start mb-1 rounded-[10px] w-[95%] md:w-full">
              ...
              <div className="flex flex-col gap-[30px] items-start justify-start rounded-[10px] w-full">
                <div className="flex flex-col font-poppins gap-6 items-center justify-start pt-1 rounded-[10px] w-full">
                  <div className="flex flex-col gap-[13px] items-start justify-start rounded-[10px] w-full">
                    ...
                    <Input
                      ...
                      className="p-0 placeholder:text-bluegray-400 sm:pr-5 text-base text-bluegray-400 text-left tracking-[0.08px] w-full"
                      wrapClassName="border border-black-900 border-solid pb-[18px] pl-4 pr-[35px] pt-6 rounded-[10px] w-full"
                      type="text"
                    ></Input>
                  </div>
                  <div className="flex flex-col gap-3.5 items-start justify-start rounded-[10px] w-full">
                    ...
                    <Input
                      ...
                      className="p-0 placeholder:text-bluegray-400 sm:pr-5 text-base text-bluegray-400 text-left tracking-[0.08px] w-full"
                      wrapClassName="border border-black-900 border-solid pb-[18px] pl-4 pr-[35px] pt-[23px] rounded-[10px] w-full"
                      type="email"
                    ></Input>
                  </div>
                ...
                <Button className="bg-bluegray-900 cursor-pointer font-medium font-poppins min-w-[400px] sm:min-w-full py-[18px] rounded-[10px] text-base text-center text-white-A700 tracking-[0.08px]">
                  Register
                </Button>
                <Text
            ...
            <div className="flex flex-col gap-[49px] items-center justify-start w-full">
              <div className="flex flex-col gap-7 items-center justify-start rounded-lg w-full">
                <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between rounded-lg w-full">
                  ...
                  <Button className="bg-bluegray-900 cursor-pointer font-semibold leading-[normal] min-w-[122px] sm:mt-0 mt-[5px] py-3 rounded-lg text-center text-sm text-white-A700 tracking-[-0.50px]">
                    View All
                  </Button>
                </div>
              ...
              >
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-[22px] items-start justify-start w-full">
                    ...
                    >
                      <div className="bg-gradient  flex flex-col md:gap-10 gap-[162px] justify-end p-[17px] w-full">
                        <Input
                          ...
                          className="font-bold leading-[normal] md:h-auto p-0 placeholder:text-white-A700 sm:h-auto text-left text-white-A700 text-xs tracking-[0.12px] w-full"
                    ...
                    <Button
                      className="bg-black-900 cursor-pointer flex items-center justify-center min-w-[151px] ml-3 md:ml-[0] pl-[30px] py-2.5 rounded-lg"
                      rightIcon={
                        <Img
                ...
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-[22px] items-start justify-start w-full">
                    ...
                    >
                      <div className="bg-gradient  flex flex-col md:gap-10 gap-[162px] justify-end p-[17px] w-full">
                        <Button className="bg-red-900 cursor-pointer font-bold leading-[normal] min-w-[78px] md:ml-[0] ml-[282px] mr-[21px] mt-1.5 py-[5px] text-center text-white-A700 text-xs tracking-[0.12px]">
                          Political
                        </Button>
                        <Text
                          className="mr-[267px] text-white-A700 text-xs tracking-[-0.50px]"
                ...
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-[21px] items-start justify-start w-full">
                    ...
                    <Button
                      className="bg-black-900 cursor-pointer flex items-center justify-center min-w-[151px] pl-[30px] py-2.5 rounded-lg"
                      rightIcon={
                        <Img
                          className="h-[18px] ml-[5px] mr-[30px] my-2.5"
                          src="images/img_upload.svg"
